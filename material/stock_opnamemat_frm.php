...
<?php 
require_once "stock_opnamemat_frm.mjs.php";
require_once "stock_opnamemat_frm.cjs.php";
?>
</head>
...
<form id="fm" method="post" onSubmit="return false">
    ...
    <div class="hdr">
      ...
      <select name="wh_id" id="wh_id" style="width:150px">
        <option value=""></option>
        <?php
            $run = $pdo->query("SELECT * FROM mat_warehouse WHERE wh_id='1' ORDER BY wh_name");
            $rs = $run->fetchAll(PDO::FETCH_ASSOC);
            foreach($rs as $r)
