...
$html = '<h2 align="center">'.$NmMenu.'</h2>'.				
		...
		<tr>
		  ...
		  <th width="80"><b>Outgoing No.</b></th>
		  <th width="80"><b>Outgoing Date</b></th>
		  <th width="80"><b>Outgoing Type</b></th>
		  <th width="80"><b>WO No.</b></th>
		  <th><b>Notes</b></th>
		</tr>
		</thead>
		<tbody>';
...
$html .= '<tr>'.
		 ...
		 '<td width="80">'.$r['matout_name'].'</td>'.
		 '<td width="80">'.$r['wo_no'].'</td>'.
		 '<td>'.$r['notes'].'</td>'.
		 '</tr>';
$no+=1;	
}
