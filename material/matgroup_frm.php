...
<?php 
require_once "matgroup_frm.mjs.php";
...
<div id="toolbar">  
	...
	<a href="javascript:void(0)" id="btnPrint" class="easyui-linkbutton" iconCls="icon-pdf" plain="true" title="Hapus">Preview</a>              
</div>
...
<div id="dlg" class="easyui-dialog" style="width:500px;height:300px;padding:10px" closed="true" buttons="#dlg-buttons">
	<form id="fm" method="post" onSubmit="return false">
 	<table>
    <tr>
      <td width="115">Mat. Group Code</td>
      <td width="319">
      <input name="matgroup_code0" type="hidden" id="matgroup_code0" class="easyui-validatebox" value="">        
      <input name="matgroup_code" type="text" id="matgroup_code" class="easyui-validatebox" value="" size="20" maxlength="20" required></td>
    </tr>
    <tr>
      <td width="115">Mat. Group Name</td>
      <td width="319">
      <input name="matgroup_name" type="text" id="matgroup_name" class="easyui-validatebox" value="" size="20" maxlength="20" required></td>
    </tr>
    <tr>
      <td>HS No.</td>
      <td><input name="HsNo" type="text" class="easyui-validatebox" id="HsNo" value="" size="50"></td>
    </tr>
    </table>
