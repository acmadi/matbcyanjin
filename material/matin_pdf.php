...
$q .= "WHERE matin_id LIKE '$matin_id' ";	  
...
$html = '<h2 align="center">'.$NmMenu.'</h2>'.		
		'<table>
		<tr>
		  <td width="80"><b>Incoming No.</b></td>
		  <td width="10"><b>:</b></td>
		  <td width="80"><b>'.$rsh[0]['matin_no'].'</b></td>
		  <td width="80"><b>Incoming Type</b></td>
		  <td width="10"><b>:</b></td>
		  <td width="150"><b>'.$rsh[0]['matin_type'].'</b></td>
		  <td width="80"><b>Incoming Date</b></td>
		  <td width="10"><b>:</b></td>
		  <td width="100"><b>'.$rsh[0]['matin_date'].'</b></td>
		</tr>
		<tr>
		  <td width="80"><b>PO No.</b></td>
		  <td width="10"><b>:</b></td>
		  <td width="80"><b>'.$rsh[0]['po_no'].'</b></td>
		  <td width="80"><b>Seller</b></td>
		  <td width="10"><b>:</b></td>
		  <td width="150"><b>'.$rsh[0]['supplier'].'</b></td>
		  <td width="80"><b>Do. Seller No.</b></td>
		  <td width="10"><b>:</b></td>
		  <td width="100"><b>'.$rsh[0]['supl_do'].'</b></td>
		</tr>
		<tr>
		  <td width="80"><b>Inv. Seller No.</b></td>
		  <td width="10"><b>:</b></td>
		  <td width="80"><b>'.$rsh[0]['supl_inv'].'</b></td>
		  <td width="80"><b>Currency</b></td>
		  <td width="10"><b>:</b></td>
		  <td width="150"><b>'.$rsh[0]['currency'].'</b></td>
		  <td width="80"><b></b></td>
		  <td width="10"><b></b></td>
		  <td width="100"><b></b></td>
		</tr>
