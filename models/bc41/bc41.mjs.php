...
function setdg(){
	...
	$('#dg').edatagrid({  
		...
		url: '<?php echo $basedir ?>models/bc41/bc41_grid.php?req=dg&CAR='+CAR,  
		saveUrl: '',  
		updateUrl: '',  
		destroyUrl: '',
...
function setdg2(){
	...
	$('#dg2').datagrid({  
		...
		columns:[[  			  						
			...
			url: '<?php echo $basedir ?>models/bc41/bc41_grid.php?req=dg2&CAR='+CAR,  
			saveUrl: '',  
			updateUrl: '',  
			destroyUrl: '',
...
function setdg2Url(row){
	...
	$('#dg2').datagrid({  
		url: '<?php echo $basedir ?>models/bc41/bc41_grid.php?req=outdet&matout_id='+row.matout_id
	});
}
...
function setdgCari(){	
	$('#dgCari').datagrid({  
		...
		url: '<?php echo $basedir ?>models/bc41/bc41_grid.php?req=dgCari', 
		saveUrl: '',  
		updateUrl: '',  
		destroyUrl: '',
...
function btnSim(){
	...
	if ($('#CAR').val() == ''){	
		...
		$.post("<?php echo $basedir ?>models/bc41/bc41_tuh.php", { 
		DokKdBc: 9,
		fhidden: $('#fhidden').val(),
		CAR: $('#CAR').val().replace(".",""),
		KdTp: $('#KdTp').val(),
...
function cari(){					
	$('#dgCari').datagrid({  
		url:"<?php echo $basedir ?>models/bc41/bc41_grid.php?req=dgCari&dtdari="+$('#dtdari').combo('getValue')+"&dtsampai="+$('#dtsampai').combo('getValue')
	});
