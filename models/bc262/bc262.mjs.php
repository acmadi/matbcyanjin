...
function setdg(){
	...
	$('#dg').edatagrid({  
		...
		url: '<?php echo $basedir ?>models/bc262/bc262_grid.php?req=dg&CAR='+CAR,  
		saveUrl: '',  
		updateUrl: '',  
		destroyUrl: '',
...
function setdg2(){
	...
	$('#dg2').datagrid({  
		...
		frozenColumns:[[  
			...
			{field:'UrBarang',title:'Uraian',width:200},
		]],
		columns:[[  			  						
			{field:'qty',title:'Jumlah',width:50,align:"right"},
			{field:'NETTO',title:'Berat Bersih<br>(kg)',width:100,align:"right"},
			{field:'VOL',title:'Volume<br>(m3)',width:100,align:"right"},
			{field:'CIF',title:'CIF',width:100,align:"right"}
		]],
		url: '<?php echo $basedir ?>models/bc262/bc262_grid.php?req=dg2&CAR='+CAR,  
		saveUrl: '',  
		updateUrl: '',  
		destroyUrl: '',
...
function setdg3(){		
	...
	$('#dg3').edatagrid({ 
		...
		url: '<?php echo $basedir ?>models/bc262/bc262_grid.php?req=dg3&CAR='+CAR,  
		saveUrl: '',  
		updateUrl: '',  
		destroyUrl: '',
		onAdd:function(index,row){rowIndex=index;},								
...
function setdgCari(){	
	$('#dgCari').datagrid({  
		...
		url: '<?php echo $basedir ?>models/bc262/bc262_grid.php?req=dgCari', 
		saveUrl: '',  
		updateUrl: '',  
		destroyUrl: '',
...
function btnSim(){
	...
	if ($('#CAR').val() == ''){	
		...
		$.post("<?php echo $basedir ?>models/bc262/bc262_tuh.php", { 
		DokKdBc: 5,
		fhidden: $('#fhidden').val(),
		CAR: $('#CAR').val().replace(".",""),
		KdTp: $('#KdTp').val(),
