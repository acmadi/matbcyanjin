...
function loaddg(){
	...
	$('#dg').datagrid({  	
		...
		url: '<?php echo $basedir; ?>models/material/stock_adjustmat_grid.php?req=load&bln='+bln+'&thn='+thn+'&wh_id='+wh_id
	});
}
...
function simpan(){
	...
	if ($('#bulan').val() == ''){ 
		...
		$.post("<?php echo $basedir ?>models/material/stock_adjustmat_tuh.php", { 
		aksi: $('#aksi').val(), 
