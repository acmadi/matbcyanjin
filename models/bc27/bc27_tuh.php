...
$KdKpbcTuj=$_POST['KdKpbcTuj'];
$KdJnsTpbAsal=$_POST['KdJnsTpbAsal'];
$KdJnsTpbTuj=$_POST['KdJnsTpbTuj'];
...
$JnsSegel=$_POST['JnsSegel'];
$CatBcTuj=$_POST['CatBcTuj'];
...
$sql[] = "INSERT INTO hdrtransaksi (
		  DokKdBc,CAR,KdVal,NDPBM,CIF,HrgSerah
		  ) VALUES (
		  '$DokKdBc','$CAR','$KdVal','$NDPBM','$CIF','$HrgSerah'
		  )";	
...
for ($i=0; $i<$jmlnodet; $i++){			
	$sql[] = "INSERT INTO barang (
			  ...
			  '$UrBarang[$i]','$qty[$i]',
			  '$NETTO2[$i]','$VOL[$i]','$CIF2[$i]','$HrgSerah2[$i]'
			  )";	
