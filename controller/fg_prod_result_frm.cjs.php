...
$('#KdBarang2').combogrid({  
	panelWidth:500,  	
	url: '<?php echo $basedir; ?>models/material/fg_prod_result_grid.php?req=dgDet',  
	idField:'KdBarang2',  
	textField:'KdBarang2',  
	mode:'remote',  
	fitColumns:true,  
...
$('#tl1Sim').click(function(){
	...
	if ($('#wh_id').val() == ''){	
		...
		throw "date-Finished Goods List";			
	} else {
		//FORM LIST BARANG
		nolist_val="";	
		KdBarang2_val="";
		...
		$.post("<?php echo $basedir ?>models/material/fg_prod_result_tuh.php", { 
		aksi: $('#aksi').val(), 
		wh_id0: $('#wh_id0').val(),
		wh_id: $('#wh_id').val(),
		date0: $('#date0').val(),
