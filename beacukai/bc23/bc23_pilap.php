...
$(function(){
	$('#dg').datagrid({
		...
		singleSelect:true,
		idField:'CAR',
		url:'<?php echo $basedir ?>models/bc23/bc23_listrpt.php',
		columns:[[  
...
function cari(){						
	$('#dg').datagrid({  
		url:"<?php echo $basedir ?>models/bc23/bc23_listrpt.php?dtdari="+$('#dtdari').combo('getValue')+"&dtsampai="+$('#dtsampai').combo('getValue')
	});
	$('#dg').datagrid('load');
}
</script>
