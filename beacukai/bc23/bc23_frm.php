...
$q="SELECT right(NoDaf,3)+1 as auto_nodaf FROM header WHERE DokKdBc='1' ORDER BY right(CAR,3) DESC LIMIT 1";
$run = $pdo->query($q);
$rs = $run->fetchAll(PDO::FETCH_ASSOC);
...
<form id="frm" name="frm" action="" method="post">
    <div class="easyui-tabs" tools="#tab-tools" style="width:710px;height:600px;">               
