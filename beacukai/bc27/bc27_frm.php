...
<?php 
require_once "bc27.mjs.php";
require_once "bc27.cjs.php";
?>
...
<form id="frm" name="frm" action="" method="post">
    <div class="easyui-tabs" tools="#tab-tools" style="width:720px;height:490px;">               
          ...
          <td>                	        	        
            ...
            <legend><b>HEADER</b></legend>
              ...
              <tr>
                ...
                <td width="172">D. TUJUAN PENGIRIMAN </td>
                <td width="176"><select id="KdTp" name="KdTp" tabindex="6">
                  <option value=""></option>
                  <?php 
              ...
              <tr>
                <td> &nbsp; &nbsp; 1. Kantor Asal</td>
                <td>
                  <select id="KdKpbcAsal" name="KdKpbcAsal" style="width:150px;" tabindex="2">
                    <option value=""></option>
                    <?php 
              ...
              <tr>
                ...
                <td>
                  <select id="KdKpbcTuj" name="KdKpbcTuj" style="width:150px;" tabindex="3">
                    <option value=""></option>
                    <?php 
					$q="SELECT * FROM kantor ORDER BY KdKpbc";
					$run = $pdo->query($q);
              ...
              <tr>
                ...
                <td>
                  <select id="KdJnsTpbAsal" name="KdJnsTpbAsal" style="width:150px;" tabindex="4">
                    <option value=""></option>
                    <?php 
              ...
              <tr>
                ...
                <td>
                  <select id="KdJnsTpbTuj" name="KdJnsTpbTuj" style="width:150px;" tabindex="5">
                    <option value=""></option>
                    <?php 
					$q="SELECT * FROM jenis_tpb ORDER BY KdJnsTpb";
					$run = $pdo->query($q);
        ...
        <tr>
          <td>
            ...
            <tr>
              ...
              <td width="50%"> Catatan BC Tujuan
                <input type="text" id="CatBcTuj" name="CatBcTuj" size="30" tabindex="25"></td> 
            </tr>
            <tr>
              <td>Jenis </td>
              <td colspan="3"><input type="text" id="JnsSegel" name="JnsSegel" maxlength="10" size="10" tabindex="24" value="Kertas"></td> 
            </tr>
            </table>
            </fieldset>
          </td>
       ...
       <div title="Data Barang" style="padding:10px;">            
            ...
            <tr>
              <td width="20%">CIF</td>     
              <td><input type="text" id="CIF" name="CIF" class="easyui-numberbox" precision="2" groupSeparator="," maxlength="10" size="12" tabindex="29"></td>
              <td colspan="2">&nbsp;</td>
            </tr>
            </table>
        </fieldset>          
