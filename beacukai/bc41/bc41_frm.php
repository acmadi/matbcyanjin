...
$q="SELECT right(CAR,6)+1 as auto_no  FROM header WHERE DokKdBc='9' ORDER BY right(CAR,6) DESC LIMIT 1";
$run = $pdo->query($q);
$rs = $run->fetchAll(PDO::FETCH_ASSOC);
$autono=($rs)?$rs[0]['auto_no']:1;
$carno = str_pad($autono, 6, "0", STR_PAD_LEFT);

$q="SELECT right(NoDaf,3)+1 as auto_nodaf FROM header WHERE DokKdBc='9' ORDER BY right(CAR,3) DESC LIMIT 1";
$run = $pdo->query($q);
$rs = $run->fetchAll(PDO::FETCH_ASSOC);
...
<?php 
require_once "bc41.mjs.php";
require_once "bc41.cjs.php";
?>
       ...
       <div title="Data Barang" style="padding:10px;">
        ...
        <fieldset class="borderblue">
            ...
            <tr>
              ...
              <td>Volume (m3)</td>
              <td>
              <input type="text" id="VOL" name="VOL" class="easyui-numberbox" precision="2" groupSeparator="," maxlength="10" size="12" tabindex="34"></td>
              <td width="25">&nbsp;</td>
            </tr>  
            <tr>
              <td>Jenis Kemasan</td>
              ...
              <td width="200">
              <input type="text" id="BRUTO" name="BRUTO" class="easyui-numberbox" precision="2" groupSeparator="," maxlength="10" size="12" tabindex="35"></td>
              <td>&nbsp;</td>
            </tr>
        <tr>
