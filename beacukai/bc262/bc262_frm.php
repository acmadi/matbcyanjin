...
$q="SELECT right(CAR,6)+1 as auto_no  FROM header WHERE DokKdBc='5' ORDER BY right(CAR,6) DESC LIMIT 1";
$run = $pdo->query($q);
$rs = $run->fetchAll(PDO::FETCH_ASSOC);
$autono=($rs)?$rs[0]['auto_no']:1;
$carno = str_pad($autono, 6, "0", STR_PAD_LEFT);

$q="SELECT right(NoDaf,3)+1 as auto_nodaf FROM header WHERE DokKdBc='5' ORDER BY right(CAR,3) DESC LIMIT 1";
$run = $pdo->query($q);
$rs = $run->fetchAll(PDO::FETCH_ASSOC);
...
<?php 
require_once "bc262.mjs.php";
require_once "bc262.cjs.php";
?>
<body oncontextmenu="return false;">
<div id="w" style="padding:5px;">
<form id="frm" name="frm" action="" method="post">
    <div class="easyui-tabs" tools="#tab-tools" style="width:720px;height:470px;">               
        ...
        <tr>
          <td>
            ...
            <table cellspacing="0" class="sub_table" width="100%">
            <tr>
              <td colspan="2"><b>PENGIRIM BARANG</b></td>  
              <td colspan="3">&nbsp;</td>
            </tr>
            <tr>
              <td width="10%">Nama</td>
       ...
       <div title="Data Barang" style="padding:10px;">
          ...
          <br>
            ...
            <tr>
              ...
              <td width="18%">CIF</td>
              <td width="32%">
                <input type="hidden" id="HrgSerah" name="HrgSerah" class="easyui-numberbox" precision="2" groupSeparator="," maxlength="10" size="12" tabindex="30" readonly>
        ...
        <fieldset class="borderblue">
            ...
            <tr>
              ...
              <td>Volume (m3)</td>
              <td>
              <input type="text" id="VOL" name="VOL" class="easyui-numberbox" precision="2" groupSeparator="," size="12" tabindex="34"></td>
              <td width="25">&nbsp;</td>
            </tr>  
            <tr>
              <td>Jenis Kemasan</td>
              ...
              <td width="200">
              <input type="text" id="BRUTO" name="BRUTO" class="easyui-numberbox" precision="2" groupSeparator="," size="12" tabindex="35"></td>
              <td>&nbsp;</td>
            </tr>
        <tr>
