...
<?php 
require_once "pelabuhan_frm.mjs.php";
...
<div id="dlg" class="easyui-dialog" style="width:500px;height:300px;padding:10px" closed="true" buttons="#dlg-buttons">
	<form id="fm" method="post" onSubmit="return false">
 	<table>
    <tr>
      <td width="115">Kode Pelabuhan</td>
      <td width="319"><input name="KdPelabuhan0" type="hidden" id="KdPelabuhan0" class="easyui-validatebox" value="">        <input name="KdPelabuhan" type="text" id="KdPelabuhan" class="easyui-validatebox" value="" size="20" maxlength="6" required></td>
    </tr>
    <tr>
      <td>Nama Pelabuhan</td>
      <td><input name="NmPelabuhan" type="text" class="easyui-validatebox" id="NmPelabuhan" value="" size="50"></td>
    </tr>
    </table>
