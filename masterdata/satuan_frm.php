...
<?php 
require_once "satuan_frm.mjs.php";
...
<div id="dlg" class="easyui-dialog" style="width:500px;height:300px;padding:10px" closed="true" buttons="#dlg-buttons">
	<form id="fm" method="post" onSubmit="return false">
 	<table>
    <tr>
      <td width="115">Kode Satuan</td>
      <td width="319"><input name="KdSat0" type="hidden" id="KdSat0" class="easyui-validatebox" value="">        <input name="KdSat" type="text" id="KdSat" class="easyui-validatebox" value="" size="20" maxlength="3" required></td>
    </tr>
    <tr>
      <td>Nama Satuan</td>
      <td><input name="UrSat" type="text" class="easyui-validatebox" id="UrSat" value="" size="50"></td>
    </tr>
    </table>
