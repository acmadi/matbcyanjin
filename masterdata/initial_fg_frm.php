...
<?php 
require_once "initial_fg_frm.mjs.php";
require_once "initial_fg_frm.cjs.php";
?>
</head>
...
<form id="fm" method="post" onSubmit="return false">
    ...
    <div class="hdr">
      ...
      <select name="wh_id" id="wh_id" style="width:150px">
        <option value=""></option>
          <?php
            $run = $pdo->query("SELECT wh_id, wh_name FROM mat_warehouse WHERE wh_id='3' ORDER BY wh_id ASC");
