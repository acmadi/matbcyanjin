...
<?php 
require_once "valuta_frm.mjs.php";
...
<div id="dlg" class="easyui-dialog" style="width:500px;height:300px;padding:10px" closed="true" buttons="#dlg-buttons">
	<form id="fm" method="post" onSubmit="return false">
 	<table>
    <tr>
      <td width="115">Kode Valuta</td>
      <td width="319"><input name="KdVal0" type="hidden" id="KdVal0" class="easyui-validatebox" value="">        <input name="KdVal" type="text" id="KdVal" class="easyui-validatebox" value="" size="20" maxlength="3" required></td>
    </tr>
    <tr>
      <td>Nama Valuta</td>
      <td><input name="UrVal" type="text" class="easyui-validatebox" id="UrVal" value="" size="50"></td>
    </tr>
    </table>
