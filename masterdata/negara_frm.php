...
<?php 
require_once "negara_frm.mjs.php";
...
<div id="dlg" class="easyui-dialog" style="width:500px;height:300px;padding:10px" closed="true" buttons="#dlg-buttons">
    ...
    <tr>
      ...
      <td width="319"><input name="KdNegara0" type="hidden" id="KdNegara0" class="easyui-validatebox" value="">        <input name="KdNegara" type="text" id="KdNegara" class="easyui-validatebox" value="" size="20" maxlength="3" required></td>
    </tr>
    <tr>
      <td>Nama Negara</td>
      <td><input name="NmNegara" type="text" class="easyui-validatebox" id="NmNegara" value="" size="50"></td>
    </tr>
    </table>
