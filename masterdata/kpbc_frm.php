...
<div id="dlg" class="easyui-dialog" style="width:500px;height:300px;padding:10px" closed="true" buttons="#dlg-buttons">
	<form id="fm" method="post" onSubmit="return false">
 	<table>
    <tr>
      <td width="115">Kode KPBC</td>
      <td width="319"><input name="KdKpbc0" type="hidden" id="KdKpbc0" class="easyui-validatebox" value="">        <input name="KdKpbc" type="text" id="KdKpbc" class="easyui-validatebox" value="" size="20" maxlength="6" required></td>
    </tr>
    <tr>
      <td>Nama KPBC</td>
      <td><input name="UrKdKpbc" type="text" class="easyui-validatebox" id="UrKdKpbc" value="" size="50"></td>
    </tr>
    <tr>
      <td>Kota</td>
      <td><input name="Kota" type="text" id="Kota" class="easyui-validatebox" value="" size="20" maxlength="20" required></td>
    </tr>
    </table>
